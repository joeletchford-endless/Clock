...
function AnimatedParagraph({ text, delay }: { text: string; delay: number }) {
  ...
  return (
    <p 
      ...
      style={{ color: colors.olive.black, minHeight: "1em" }}
    />
  )
}
...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full pb-0 sm:pb-6">
        <svg 
          ref={svgRef}
        ...
        >
          {/* E */}
          <path d="M0 243.434V5.00208H180.741V53.6888H59.0243V96.373H163.401V142.392H59.0243V193.413H182.742V243.434H0Z" fill={colors.olive.black}/>
          {/* N */}
          <path d="M190.176 243.434V5.00208H249.534L320.229 124.718C323.898 131.387 336.57 155.064 336.57 155.064H337.236C337.236 155.064 336.57 126.385 336.57 118.049V5.00208H394.26V243.434H334.902L264.873 125.385C260.872 119.049 247.866 93.3718 247.866 93.3718H247.199C247.199 93.3718 247.866 124.051 247.866 132.388V243.434H190.176Z" fill={colors.olive.black}/>
          {/* D */}
          <path d="M460.718 193.746H495.399C534.082 193.746 554.09 169.403 554.09 125.718C554.09 82.3673 533.082 54.3557 496.066 54.3557H460.718V193.746ZM401.694 243.434V5.00208H503.403C569.43 5.00208 613.781 52.6884 613.781 125.718C613.781 167.736 599.109 201.416 572.431 221.758C553.757 235.764 529.747 243.434 499.734 243.434H401.694Z" fill={colors.olive.black}/>
          {/* L */}
          <path d="M620.153 243.434V5.00208H679.178V193.413H786.222V243.434H620.153Z" fill={colors.olive.black}/>
          {/* E */}
          <path d="M793.656 243.434V5.00208H974.397V53.6888H852.68V96.373H957.056V142.392H852.68V193.413H976.398V243.434H793.656Z" fill={colors.olive.black}/>
          {/* S */}
